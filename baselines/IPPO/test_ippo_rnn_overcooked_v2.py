...
def get_rollout(train_state, config, network2_params=None, rnn_params=None, 
    ...
    artifact_basename = f"rollout_data_seed_{seed_num}_layout_name_{layout_name}_speeds_{AGENT_1_1_SPEED}{AGENT_1_2_SPEED}"
...
def main(config):
    ...
    batch_filename = f"rollouts_batch_{layout_name}_seeds_{seed_start}_to_{seed_end}.h5"
