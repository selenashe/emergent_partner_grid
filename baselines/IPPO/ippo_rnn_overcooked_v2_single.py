    ...
    def train(rng, preloaded_params=None, preloaded_params_2=None, model1_params=None, model2_params=None):
        ...
        def _update_step(runner_state, unused):
            ...
            def _env_step(runner_state, unused):
                ...
                allowed_speeds = jnp.array([2])
                new_slow_delay_0 = jax.random.choice(rng_slow0, allowed_speeds, (config["NUM_ENVS"],))
                new_slow_delay_1 = jax.random.choice(rng_slow1, allowed_speeds, (config["NUM_ENVS"],))
        ...
        allowed_speeds = jnp.array([2])
        slow_delay_init_0 = jax.random.choice(_rng, allowed_speeds, (config["NUM_ENVS"],))
        slow_delay_init_1 = jax.random.choice(_rng, allowed_speeds, (config["NUM_ENVS"],))
...
def main(config):
    ...
    wandb.init(
        ...
        name=f"single_ippo_rnn_overcooked_v2_{layout_name}",
    )
